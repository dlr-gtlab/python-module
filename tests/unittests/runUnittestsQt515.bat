...
SET PATH=%PATH%;build;lib;lib\%TARGETDIRNAME%;C:\Qt\Qt5.15\5.15.2\msvc2019_64\bin;%DEVTOOLS%\binDebug;%DEVTOOLS%\binDebug\modules;%DEVTOOLS%\bin;%DEVTOOLS%\bin\modules
