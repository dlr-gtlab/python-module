...
### Fixed
 - Fixed deadlock when running python tasks from GTlabConsole when DLRp2 has been loaded as well. This was a regression introduced in 1.8.1,
   that allows the python module be loaded also from a native python interpreter. The code has been changed to avoid deadlocking.
